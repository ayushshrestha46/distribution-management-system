...
import { 
  Users, ShoppingBag, Phone, Mail, MapPin, 
  Calendar, CheckCircle, XCircle, RefreshCw,
  Clock, Package, Search, Filter, X
} from "lucide-react";
      ...
      <div className="flex items-center justify-center h-96">
        <div className="text-center space-y-4">
          ...
          <div className="space-y-2">
            <p className="text-lg font-medium text-gray-800">Loading retailers...</p>
            <p className="text-sm text-gray-500">Gathering retailer information</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="w-full max-w-2xl border border-red-200 rounded-xl bg-white shadow-sm">
          ...
          <div className="p-6 space-y-4">
            <p className="text-gray-600">
              There was a problem loading your retailers. This could be due to network issues or server problems.
            </p>
            <div className="flex gap-3">
              <button onClick={() => window.location.reload()} className="inline-flex items-center justify-center gap-2 rounded-md bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700">
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-gray-50">
                <tr>
                  <th className="px-4 py-3 text-left text-sm font-medium text-gray-500 w-[240px]">Retailer</th>
                  <th className="px-4 py-3 text-left text-sm font-medium text-gray-500 w-[220px]">Location</th>
                  <th className="px-4 py-3 text-left text-sm font-medium text-gray-500 w-[220px]">Contact</th>
                  <th className="px-4 py-3 text-left text-sm font-medium text-gray-500 w-[120px]">Status</th>
                  <th className="px-4 py-3 text-left text-sm font-medium text-gray-500 w-[140px]">Customer Since</th>
                  <th className="px-4 py-3 text-left text-sm font-medium text-gray-500 w-[100px]">Orders</th>
                </tr>
              </thead>
              <tbody>
                  ...
                  <tr key={retailer._id} className="group hover:bg-gray-50">
                    ...
                    <td className="px-4 py-4">
                      <div className="flex items-center text-sm text-gray-600">
                        ...
                        <span className="truncate max-w-[160px]" title={retailer.address}>
                          {retailer.address}
                        </span>
                      </div>
                    </td>
                    <td className="px-4 py-4">
                      <div className="space-y-2">
                        <div className="flex items-center text-sm text-gray-600">
                          ...
                          <span className="truncate max-w-[160px]" title={retailer.email}>
                            {retailer.email}
                          </span>
                        </div>
                        <div className="flex items-center text-sm text-gray-600">
                    ...
                    <td colSpan={6} className="text-center py-12">
                      <div className="flex flex-col items-center justify-center text-gray-500 space-y-2">
                        ...
                        {searchTerm ? (
                          ...
                          <p className="text-sm">No retailers match your current filters</p>
                        )}
                      </div>
                    </td>
                  </tr>
